...
**The Good News:** 80% of all chronic disease and healthcare costs can be halted and reversed by turning off your "fat switch."`,
  },
  {
    ...
    category: "quickstart",
    summary: "The survival switch that protects us - and how it's become stuck.",
...
Obese humans have the fat switch stuck in the "on position" - and it's responsible for all cardio-metabolic disease.`,
  },
  {
    ...
    category: "quickstart",
    summary: "The unique way fructose metabolism creates a cellular energy crisis.",
...
**Foods High in Heated Seed Oils:**
- French fries
- Fried chicken
- Chips and snacks
...
- Track portion sizes`,
  },
  {
    ...
    category: "greensheets",
    summary: "Foods that can disrupt metabolic health and trigger insulin spikes.",
...
Last updated: January 2026`,
  },
  {
    ...
    category: "science",
    summary: "Understanding the biological mechanism that controls fat storage.",
...
The mitochondria repair themselves because they're no longer being damaged by uric acid-induced oxidative stress.`,
  },
  {
    ...
    category: "science",
    summary: "The insulin-lowering cascade that restores metabolic flexibility.",
...
- Growth hormone (fat-burning, muscle-building) peaks during deep sleep`,
  },
  {
    ...
    category: "science",
    summary: "Simple techniques to lower cortisol and support metabolic health.",
